            ...
            <div className='grid lg:grid-cols-2 gap-10'>
                ...
                <div className='flex flex-col justify-center space-y-8'>
                    <div>
                        ...
                        <p className='text-gray-300 my-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum quaerat non distinctio iusto velit rem, praesentti cum debitis unde possimus animi sapiente dolor a tempore.</p>
                        <h3 className='text-2xl font-semibold text-gray-300'>Email</h3>
                        <p className='text-gray-600 mt-2'>
                            <a href="#" className='text-blue-500 hover:underline'>anujapradhan731@gmail.com</a>
                        </p>
                    </div>
                    <div>
                        <h3 className='text-2xl font-semibold text-gray-300'>Phone</h3>
                        <p className='text-gray-600 mt-2'>
                            <a href="#" className='text-blue-500 hover:underline'>+91 7205962120</a>
                        </p>
                    </div>
                    <div>
                ...
                {/* Contact form */}
                <div className='bg-black rounded-lg shadow-[0px_0px_10px_10px_rgba(0,0,0,0.3)] shadow-blue-500 p-8'>
